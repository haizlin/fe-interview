...
## Today's Interview Question (2019.07.05) —— 80 days
...
- [skill] [你知道什么是websocket吗？它有什么应用场景？](https://github.com/haizlin/fe-interview/issues/575)
...
- Topics(Please look forward to and welcome PR)  
    [ES6](category/es6.md) | [NodeJs](category/nodejs.md) | [jQuery](lib/jQuery.md) | [Vue 220+](lib/Vue.md) | [React](lib/React.md) | [AngularJs](lib/AngularJs.md) | [小程序](lib/wxapp.md)
...
- 78 days  (2019.07.03)
    ...
    - [skill] [你有使用过JWT吗？说说你对它的理解](https://github.com/haizlin/fe-interview/issues/565)
...
- 79 days (2019.07.04)
    ...
    - [skill] [一个项目写很多的纯静态页面，有公共的部分（例如头和尾）你是怎么提取公用的？](https://github.com/haizlin/fe-interview/issues/571)
...
- 2019.07.05 — 第80天，为期一周的热榜结束，收获star数达到2857，在github中“前端面试”的star排名第7，前进了3名，非常感谢**jsliang的梁兄弟**的推荐才使得有这么一波流量，恢复平静，专心出题，坚持做得更好，期待下一波流量的到来！对了，今天公司9周年，专门录制了个视频，等待申请通过后再把链接发出来！

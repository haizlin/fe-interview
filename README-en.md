...
## :clock430: Today's Knowledge Points (2020.11.05) —— 569 days  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:four: [skill] [1.1版本http协议中的管道机制和非管道情况下处理差别体现在哪里？](https://github.com/haizlin/fe-interview/issues/3148)  
...
- 568 days (2020.11.04)  
	 ...
	 :four: [skill] [1.1版本单个tcp连接下的http请求为什么只能同步处理？](https://github.com/haizlin/fe-interview/issues/3144)  
